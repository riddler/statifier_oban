# Quality configuration for statifier_oban.
#
...
[
  ...
  # files, a relative link in a Markdown extra to a file that is not itself
  # an extra (moduledoc links are the Docs stage's), two extras sharing a
  # basename, and a silent rewrite to a different extra.
